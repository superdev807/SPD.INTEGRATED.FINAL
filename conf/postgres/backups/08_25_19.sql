...
--
-- Name: spd_subscription_options_duration_id_seq; Type: SEQUENCE; Schema: public; Owner: spd_web_django_local
--

CREATE SEQUENCE public.spd_subscription_options_duration_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.spd_subscription_options_duration_id_seq OWNER TO spd_web_django_local;

--
-- Name: spd_subscription_options_duration_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: spd_web_django_local
--

ALTER SEQUENCE public.spd_subscription_options_duration_id_seq OWNED BY public.spd_subscription_options_duration.id;
...
--
-- Name: spd_subscription_options_duration id; Type: DEFAULT; Schema: public; Owner: spd_web_django_local
--

ALTER TABLE ONLY public.spd_subscription_options_duration ALTER COLUMN id SET DEFAULT nextval('public.spd_subscription_options_duration_id_seq'::regclass);
...
COPY public.spd_subscription_options_duration (id, display, calendar_days) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.spd_subscription_options_access_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_subscription_options_cost_id_seq', 1, false);


--
-- Name: spd_subscription_options_duration_id_seq; Type: SEQUENCE SET; Schema: public; Owner: spd_web_django_local
--

SELECT pg_catalog.setval('public.spd_subscription_options_duration_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_subscription_options_records_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_subscription_options_renewable_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_subscription_options_trial_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_subscription_options_user_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.spd_test_fk_subscription_type_id_seq', 1, false);
...
--
-- Name: spd_subscription_options_duration spd_subscription_options_duration_pkey; Type: CONSTRAINT; Schema: public; Owner: spd_web_django_local
--

ALTER TABLE ONLY public.spd_subscription_options_duration
    ADD CONSTRAINT spd_subscription_options_duration_pkey PRIMARY KEY (id);
...
--
-- Name: spd_test_fk_subscription_type spd_test_fk_subscrip_Duration_id_0d407f5d_fk_spd_subsc; Type: FK CONSTRAINT; Schema: public; Owner: spd_web_django_local
--

ALTER TABLE ONLY public.spd_test_fk_subscription_type
    ADD CONSTRAINT "spd_test_fk_subscrip_Duration_id_0d407f5d_fk_spd_subsc" FOREIGN KEY ("Duration_id") REFERENCES public.spd_subscription_options_duration(id) DEFERRABLE INITIALLY DEFERRED;
